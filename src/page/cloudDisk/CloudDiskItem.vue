<template>
    <div class="chatList" v-bind:class="{selected:$route.meta.childCompName==isCurrentConversation}" @click="showCloudDisk">
        <div class="chat_item online slide-left">
            <div class="photo">
                ...
                <div class="portrait iconfont" v-show="imagePath=='&#xe6a2;'" style="font-size: 27px;background:#ff9d00;">&#xe6a2;</div>
