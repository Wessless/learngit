<template>
    <div class="ParentschoolContactDetail" @drop="drop($event)" @dragenter="dragenter($event)" @dragleave="dragleave($event)" @dragover="dragover($event)">
        ...
        <el-form ref="form" :model="form" label-width="100px" style="width:100%;">
            <el-form-item label="" v-show="$route.meta.type=='add'">
                <el-radio v-model="form.type" label="0">班级通知</el-radio>
                <el-radio style="margin-left:30px;" v-model="form.type" label="1">班级作业</el-radio>
                <el-radio style="margin-left:30px;" v-model="form.type" label="2">今日所学</el-radio>
            </el-form-item>
            <el-form-item label="班级">
                <el-select v-model="form.classID" size="small" :disabled="disabled" filterable style="width:400px;" placeholder="请选择班级">
                    <el-option
