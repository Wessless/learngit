        ...
        <div style="width:100%;padding-top:54px;padding-bottom:20px;">
            <el-form :inline="true" :model="form" class="demo-form-inline">
                <el-form-item label="班级">
                    <el-select v-model="form.classID" filterable size="medium" @change="loadList" style="width:150px;" placeholder="请选择班级">
                        <el-option
                ...
                <el-table-column label="文字内容" width="">
                    <template slot-scope="scope">
                        <el-popover width="500" trigger="hover" placement="bottom">
                            ...
                            <div slot="reference" @click="examinePhotoes(scope.row)">
...
import { getPhotoes,getAllClasses } from '@/js/api'
