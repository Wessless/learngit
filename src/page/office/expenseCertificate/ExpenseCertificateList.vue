<template>
    <div class="expense">
        <chat-header :showBack="true" :title="'报销凭证'" :showRightBtn="false"></chat-header>
        ...
        <div class="expenseList">
            <expense-certificate-item v-for="item in expenseList" :key="item.num" :item="item" @clickChangeChargeDate="clickChangeChargeDate"></expense-certificate-item>
        </div>
...
import { bchargeDateInput,chargeCheckList } from '@/js/api'
import { showLoading,closeLoading,alertError,dateTimeFormatter} from '@/config/utils'
import { mapState, mapMutations } from 'vuex'
import ChatHeader from '@/components/chat/ChatHeader'
import expenseCertificateItem from '@/page/office/expenseCertificate/ExpenseCertificateItem'
import NoData from '@/components/chat/NoData'

export default {
    name: 'ExpenseCertificate',
    data(){
        return {
            formInline: {
                daterange: [],
    ...
    methods:{
        loadList(){
            ...
            chargeCheckList(this.formInline.daterange[0],this.formInline.daterange[1],this.formInline.sort).then((result)=>{
