<template>
    <div class="expenseAccountDetail">
        ...
        <el-form ref="form" :model="form" label-width="120px" style="width:100%;">
            ...
            <el-form-item label="凭证号" class="firstBg" style="padding-top:3px;">
                <el-input v-model="form.warrantNumber" size="small" style="width:600px;" placeholder="请输入凭证号"></el-input>
            </el-form-item>
            ...
            <el-form-item label="" style="padding-top:3px;margin-bottom:-8px;">
                <el-checkbox v-model="checked">设定为延期付款(进入应付款账目)</el-checkbox>
            </el-form-item>
            ...
            <el-form-item :label="'支付日期'">
                ...
                <label style="color:#606266;margin:0 8px;">银行账号</label>
                <el-select v-model="form.repayBankAccount" size="small" style="width:300px;" :disabled="isDisabled" filterable :placeholder="'请选择银行账号'">
                    <el-option
...
import { GetRateSets,getCompany,getBankAccount,getAllBigType,
        getSmallType,getSubject,findAllRetiredStaffs,
        getOutBill,getOutBillDetail,getMarginMoneySumByStaffID,delChargeBillImg,
        getCustomerManage,addChargeAttachment,addBillRecord,getChargeBillByID } from '@/js/api'
    ...
    methods:{
        ...
        confirm(){
            ...
            let json = {
                ...
                isSetDelayPay : this.checked?"1":"0",
                bankAccountID : this.form.repayBankAccount != ""?this.form.repayBankAccount:"-1",
            ...
            addBillRecord(json).then((result)=>{
        ...
        loadAddList(){
            ...
            Promise.all([
                ...
                this.form.bankList = result[2].data.data;
        ...
        getNowDate() {
            ...
            this.form.payDate = year + "-" + month + "-" + strDate;
        },
    }
}
</script>
