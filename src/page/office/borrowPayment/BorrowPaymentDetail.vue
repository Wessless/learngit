    ...
    <div class="expenseDetail">
        ...
        <div class="detailList">
            ...
            <div class="detailItem">
                ...
                <div class="detailContent" style="white-space: normal;">{{detail.Reason}}</div>
            </div>
            <div class="detailItem">
...
import { getBookChargeByID,downloadFile,signExamine } from '@/js/api'
...
export default {
    ...
    methods:{
        ...
        addChargeNo(){
            ...
            addChargeNo(this.detail.ChargeBillID,this.detail.WarrantNumber).then((result)=>{
        ...
        confirm(){
            ...
            let id = this.$route.params.borrowID.split("&")[1];
        ...
        loadDetail(){
            ...
            if (this.$route.meta.type=="approve"||this.$route.meta.type=="examine") {
                id = this.$route.params.borrowID.split("&")[0];
            }else{
                id = this.$route.params.borrowID;
            }
            let loading = showLoading();
            getBookChargeByID(id).then((result)=>{
                closeLoading(loading);
                let obj = result.data;
                console.log(result);
