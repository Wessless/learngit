...
import { GetRateSets,getCompany,findStaffByStaffID,getAllBigType,
        ...
        getCustomerManage,addChargeAttachment,addChargeBill,addBookCharge,getBookChargeByID } from '@/js/api'
...
export default {
    ...
    methods:{
        ...
        confirm(){
            ...
            addBookCharge(json).then((result)=>{
