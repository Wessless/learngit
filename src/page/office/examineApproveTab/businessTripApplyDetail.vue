<template>
    <div class="businessTripApplyDetail">
        ...
        <el-form ref="form" :model="form" label-width="120px" style="width:100%;">
            <el-form-item label="出差地点">
                <el-input v-model="form.tripPlace" size="small" style="width:600px;" placeholder="请输入出差地点"></el-input>
            </el-form-item>
            ...
            <el-form-item label="出差天数">
                <el-input placeholder="请输入内容" v-model="form.outOfDay" size="small" style="width:600px;">
                    <template slot="append">天</template>
                </el-input>
            </el-form-item>
            <el-form-item label="出差事由" class="ReceiveApplyDetail_signatory">
                <el-input v-model="form.goReason" size="small" type="textarea" :rows="4" style="width:600px;padding: 4px 0px 7px 0;" placeholder="请输入出差事由"></el-input>
            </el-form-item>
...
export default {
    ...
    methods:{
        ...
        confirm(){
            ...
            let obj = {name:"出差地点",value:this.form.tripPlace};
            let obj1 = {name:"开始时间",value:this.form.beginDateTime};
            let obj2 = {name:"结束时间",value:this.form.endDateTime};
            let obj3 = {name:"出差天数",value:this.form.outOfDay};
            let obj4 = {name:"出差事由",value:this.form.goReason};
            let array = [];
            array.push(obj);
            array.push(obj1);
            array.push(obj2);
            ...
            console.log(this.form.outOfDay)
