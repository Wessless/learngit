    ...
    <div class="borrowAccountDetail">
        ...
        <el-form ref="form" :model="form" label-width="120px" style="width:100%;">
            ...
            <el-form-item :label="'支付日期'">
                ...
                <el-select v-model="form.repayBankAccount" size="small" style="width:300px;" filterable :placeholder="'请选择银行账号'">
                    <el-option
...
import { GetRateSets,getCompany,getBankAccount,getAllBigType,
        ...
        getCustomerManage,addChargeAttachment,addChargeBill,addChargeRecord,getBookChargeByID } from '@/js/api'
import { showLoading,closeLoading,money,alertError} from '@/config/utils'
import { mapState, mapMutations } from 'vuex'
import ChatHeader from '@/components/chat/ChatHeader'

export default {
    name: 'borrowAccountDetail',
    data(){
        return {
            title:"",
            disabled:true,
    ...
    methods:{
        ...
        // 点击确认保存模板
        confirm(){
            // {"OutType":"","DetailID":"","DetailName":"","Ratio":""}
            let billOutsList = [];
            ...
            addChargeRecord(json).then((result)=>{
