    ...
    <div class="ApplyExamineDetail">
        ...
        <el-form ref="form" :model="form" label-width="80px" style="width:100%;">
            ...
            <el-form-item label="签字人" style="width:500px;" class="ReceiveApplyDetail_signatory">
                <div v-show="this.form.FinalSigned1!=''"> 
                    <label class="labeleg" :disabled="true">{{this.form.FinalSigned1}}</label>
                    <el-radio v-model="radio1" label="1" :disabled="true">同意</el-radio>
                    <el-radio v-model="radio1" label="0" :disabled="true">不同意</el-radio>
                    <el-input class="input_move" v-model="form.note1" size="small" style="width:400px;" :disabled="true">{{this.form.note1}}</el-input>
                </div>
                <div v-show="this.form.FinalSigned2!=''">
                    <label class="labeleg" :disabled="true">{{this.form.FinalSigned2}}</label>
                ...
                <div v-show="this.form.FinalSigned3!=''">
                    <label class="labeleg" :disabled="true">{{this.form.FinalSigned3}}</label>
                    <el-radio v-model="radio3" label="1" :disabled="true">同意</el-radio>
                    <el-radio v-model="radio3" label="0" :disabled="true">不同意</el-radio>
                    <el-input class="input_move" v-model="form.note3" size="small" style="width:400px;" :disabled="true">{{this.form.note3}}</el-input>
                </div>
            </el-form-item>
...
import {getApplyDetailByAplyId,getCanUseGoods,getOccupyList } from '@/js/api'
    ...
    methods:{ 
        ...
        loadUpdateReceiveApplyDetail(){
            ...
            .then((result)=>{
                ...
                //签字人
                this.form.FinalSigned1 = obj[0].FinalSigned1?obj[0].FinalSigned1:"";
                this.form.FinalSigned2 = obj[0].FinalSigned2?obj[0].FinalSigned2:"";
                this.form.FinalSigned3 = obj[0].FinalSigned3?obj[0].FinalSigned3:"";
                this.form.Signed1 = obj[0].Signed1?obj[0].Signed1:"";
                this.form.Signed2 = obj[0].Signed2?obj[0].Signed2:"";
                this.form.Signed3 = obj[0].Signed3?obj[0].Signed3:"";
                this.form.note1 = obj[0].Note1?obj[0].Note1:"";
                this.form.note2 = obj[0].Note2?obj[0].Note2:"";
                this.form.note3 = obj[0].Note3?obj[0].Note3:"";
