...
(function (RongIMLib) {
    ...
    var MessageUtil = (function () {
        ...
        MessageUtil.checkStorageSize = function () {
            return JSON.stringify(sessionStorage).length < 4680000;
        };
        ...
        function LocalStorageProvider() {
            ...
            for (var key in sessionStorage) {
                if (key.lastIndexOf('RECEIVED') > -1) {
                    var recObj = JSON.parse(sessionStorage.getItem(key));
                    ...
                    if (RongIMLib.RongUtil.isEmpty(recObj)) {
                        ...
                        sessionStorage.setItem(key, JSON.stringify(recObj));
                    }
                }
                if (key.lastIndexOf('SENT') > -1) {
                    var sentObj = JSON.parse(sessionStorage.getItem(key));
                    nowDate - sentObj.dealtime > 0 && (sessionStorage.removeItem(key));
                }
            }
        }
